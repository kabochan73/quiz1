<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">カテゴリを編集</h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="bg-white shadow sm:rounded-lg p-6">
                <form method="POST" action="{{ route('categories.update', $category) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">自分自身と、その下の階層は親に選べません。</p>
                    </div>
            ...
            <div class="bg-white shadow sm:rounded-lg p-6">
                <h3 class="text-sm font-medium text-gray-900">このカテゴリを削除</h3>
                <p class="mt-1 text-xs text-gray-500">サブカテゴリがあれば一緒に削除されます。クイズは削除されず「未分類」になります。</p>
